...
//    }
    ...
    public SendEmailUtil(String host, String port, String protocol, String account, String pass, String to, String subject, String content, String fileStr) {
        this.host = host;
    ...
    public void send() {
        ...
        try {
            //发件人
            mimeMessage.setFrom(new InternetAddress(account, "Tandexue"));        //可以设置发件人的别名
